...
** Updating Debian
   ...
   Debian can be kept up-to-date by ensuring first that we have the
...
deb http://security.debian.org/ wheezy/updates main contrib non-free
   ...
   So long as we have access to these repositories, frequent =apt-get
   update && apt-get upgrade= commands will download and install
